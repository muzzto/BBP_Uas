...
class TodoView
{
    public function renderAddSection($error)
    {
        ?>
    ...
    public function renderTodoItems($todos)
    {
        if ($todos->rowCount() <= 0) { ?>
            <div class="todo-item">
                <div class="empty">
...
<body>
    <div class="main-section">
        <?php $todoView->renderAddSection(isset($_GET['mess']) && $_GET['mess'] == 'error'); ?>

        <div class="show-todo-section">
            <?php $todoView->renderTodoItems($todos); ?>
        </div>
    </div>
